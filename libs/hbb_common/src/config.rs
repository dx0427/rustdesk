...
pub const RENDEZVOUS_SERVERS: &[&str] = &["101.200.14.6"];
pub const PUBLIC_RS_PUB_KEY: &str = "dRFN+HDHgM4KdwHOxpLtxdBtWwgeVzX2uHNNxHn5hho=1dRFN+HDHgM4KdwHOxpLtxdBtWwgeVzX2uHNNxHn5hho=";
